    ...
    return (
        <div className="bg-signup">
            ...
            <div className="h-screen flex items-center justify-center">
                ...
                <div className='flex justify-center font-bold text-5xl text-light-green'>SIGN UP</div>
                    <div>
                        <input
                    ...
                    <div>
                        <select name="nationality" className='bg-beige rounded-lg p-3 placeholder-blue caret-blue text-blue w-full max-w-xs' onChange={(e) => setNationality(e.target.value)} required>
